...
<body>
  <div class="pdf-page">
    <div class="header">
      ...
      <div>
        <div style="font-size: 22px; font-weight: 800; font-family: 'Outfit', sans-serif;">Secur<span style="color: #7C3AED;">AI</span></div>
  ...
  <div class="pdf-page">
    ...
    <div class="pdf-page">
      ...
      <div style="font-weight: 700; color: #888888; margin-bottom: 4px;">SecurAI Credential Scanner</div>
      <div>Generated dynamically by SecurAI Security Analysis Engine</div>
  ...
  async function triggerDownload(project) {
    ...
    try {
      ...
      pdf.save(`securai_report_${project.projectName}.pdf`);
    ...
    <div class="bg-card-warm border border-dark-charcoal/10 p-6 sm:p-8 rounded-3xl max-w-2xl w-full shadow-2xl flex flex-col max-h-[85vh]">
      ...
      <div class="flex-1 overflow-y-auto bg-[#0a0a0a] border border-[#2a2a2a] rounded-2xl p-6 shadow-inner">
        <div class="flex items-center gap-3 mb-6">
          ...
          <div>
            <div class="text-lg font-bold font-display text-white">Secur<span class="text-accent-purple">AI</span></div>
        ...
        <div class="text-center text-[8px] text-gray-600">
          Generated by SecurAI Credential Scanner &mdash; AI-Assisted Data Leakage Detection
        </div>
      </div>
